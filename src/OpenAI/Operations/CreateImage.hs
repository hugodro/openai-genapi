...
module OpenAI.Operations.CreateImage where
...
createImage :: forall m . OpenAI.Common.MonadHTTP m => CreateImageRequest -- ^ The request body to send
  -> OpenAI.Common.ClientT m (Network.HTTP.Client.Types.Response CreateImageResponse) -- ^ Monadic computation which returns the result of the operation
createImage body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either CreateImageResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> CreateImageResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                    ImagesResponse)
                                                                                                                                                         | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (OpenAI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "POST") "/images/generations" GHC.Base.mempty (GHC.Maybe.Just body) OpenAI.Common.RequestBodyEncodingJSON)
...
data CreateImageResponse =
  ...
  | CreateImageResponse200 ImagesResponse -- ^ OK
